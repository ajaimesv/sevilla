...
extern "C" DLL_EXPORT
const char* sevilla_http_client_request(const char* request) {
...
extern "C" DLL_EXPORT
const wchar_t* sevilla_http_client_request_wchar_t(const wchar_t* request) {
    ...
    try {
        ...
        converted = converter.from_bytes(sevilla_http_client_request(u8_request.c_str()));
