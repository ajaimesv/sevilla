...
extern "C" DLL_EXPORT
const char* sevilla_email_client_send_email(const char* request) {
...
extern "C" DLL_EXPORT
const wchar_t* sevilla_email_client_send_email_wchar_t(const wchar_t* request) {
    ...
    try {
        ...
        converted = converter.from_bytes(sevilla_email_client_send_email(u8_request.c_str()));
